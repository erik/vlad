...
all: $(OBJ) json luad
	@echo "Linking..."
	@$(DMD) $(OBJ) $(INCS) $(DMDFLAGS) $(LIBS) -of$(EXE)
...
src/vlad/main.o: src/vlad/main.d src/vlad/bot.d src/vlad/config.d src/vlad/commands.d
src/vlad/lua.o: src/vlad/lua.d
...
vendor/luad/luad.o: $(LUADSRC)
	@echo "Building LuaD..."
	@$(DMD) -c -lib $(LUADSRC) $(LIBLUA) -of$(LIBLUAD)
